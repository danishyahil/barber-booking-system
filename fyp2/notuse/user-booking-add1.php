...
{
	header( "Location: user-booking-add.php" );
	return false;
}
?>
<?PHP
...
<!--- Toast Notification -->
<?PHP 
if($success) { Notify("success", $success, "user-booking.php"); }
?>	
	  ...
	  <div class="w3-row w3-white w3-card w3-padding">
		...
		<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			...
			<tr>
				...
				<td><?PHP echo $data["address"] ;?> <a target="_blank" href="<?PHP echo $data["gmap"]; ?>" class="w3-button w3-blue w3-round"><i class="fa fa-fw fa-map-marker fa-lg"></i>  Direction</a></td>
				<td>
				<a href="#" onclick="document.getElementById('idRate<?PHP echo $bil;?>').style.display='block'" class="w3-button w3-red w3-round">Rating</a>
				</td>
				<td>
				<a href="#" onclick="document.getElementById('idEdit<?PHP echo $bil;?>').style.display='block'" class="w3-button w3-red w3-round">Make Appointment</a>
				</td>
			</tr>
	...
	<div class="w3-modal-content w3-round-large w3-card-4 w3-animate-zoom" style="max-width:500px">
      <header class="w3-container "> 
		...
		<div class="w3-bar w3-white">
			<button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">All Rating</button>
...
<div id="idEdit<?PHP echo $bil; ?>" class="w3-modal" style="z-index:10;">
	<div class="w3-modal-content w3-round-large w3-card-4 w3-animate-zoom" style="max-width:500px">
      <header class="w3-container "> 
		...
		<form action="" method="post" >
			<div class="w3-padding"></div>
			<b class="w3-large">Make Appointment</b>
			<hr>
