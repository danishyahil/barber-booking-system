...
{	
	$SQL_insert = " 
	INSERT INTO `booking`(`id_booking`, `id_customer`, `id_barber`, `date`, `slot`, `location`, `status`, `created_date`) VALUES (NULL,'". $_SESSION["id_customer"] . "','$id_barber','$date','$slot','$location', 0, NOW() )
	";	
...
<div class="w3-panel w3-green w3-display-container w3-animate-zoom">
  ...
  <h3>Success!</h3>
  <p>Your appointment was successful booked!</a> </p>
</div>
<?PHP  } ?>	
		...
		<form action="" method="post" >
			...
			<div class="w3-section w3-row w3-border w3-round w3-padding " >
			  ...
			  <div class="w3-col s8" >
                ...
                <?PHP echo $data["services"]; ?><br>
                <a target="_blank" href="<?PHP echo $data["gmap"] ;?>" class="w3-tag w3-blue w3-round"><i class="fa fa-fw fa-map-marker fa-lg"></i> Direction</a>
                <a href="#" onclick="document.getElementById('idRate<?PHP echo $bil;?>').style.display='block'" class="w3-tag w3-red w3-round"><i class="fa fa-fw fa-star fa-lg"></i>Rating</a>
				</div>
			  </div>
              ...
              <div class="w3-section " >
				...
				<select class="w3-input w3-border w3-round" name="" value="slot" required>
					<option value="9.00am">Haircut - ET 30 Minutes</option>
					<option value="10.00am">Haircut and Wash - ET 1 Hour 15 Minutes</option>
					<option value="11.00am">Wash And Styling - ET 30 Minutes</option>
					<option value="12.00pm">Facial - ET 20 Minutes</option>
				</select>
			  </div>
			...
			<button type="submit" class="w3-button w3-wide w3-red w3-text-white w3-margin-bottom w3-round">BOOK</button>
